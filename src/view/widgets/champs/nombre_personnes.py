...
class Champ_nb_personnes(QSpinBox):
	...
	def __init__(self, menu:"Parametres", nom: str) -> "Champ_nb_personnes":
		"""
		Le constructeur du champ permettant de choisir 
		le nombre de personne au départ dans la simulation
		
		:param menu: Son composant parent
		:type menu: "Parametres"
		:param nom: Son nom
		:type nom: str
		:return: Le Champ_nb_personnes instancié
		:rtype: Champ_nb_personnes
		"""
		super().__init__()
