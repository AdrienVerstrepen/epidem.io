...
class Bouton_reinitialiser(QPushButton):
	...
	"""La barre de boutons parente contenant les actions de contrôle."""
	
	text : "str"
	"""Le texte affiché sur le bouton."""
	
	appui : "None"
	"""Appelée lors de l'appui sur le bouton. 
	Réinitialise les composants liés au démarrage, 
	à la pause et réinitialise la simulation graphique."""
	def __init__(self, sa_barre : "Barre_boutons", texte: str) -> "Bouton_reinitialiser":
		"""
		Constructeur du Bouton de réinitialisation
		
		:param sa_barre: Son composant parent
		:type sa_barre: "Barre_boutons"
		:param texte: Son texte
		:type texte: str
		:return: Le composant Bouton_reinitialiser instancié
		:rtype: Bouton_reinitialiser
		"""
		super().__init__()
		self.text = texte
		self.setText(texte)
	...
	def appui(self) -> None:
		...
		réinitaliser les états des boutons et la simulation"""
